...
predictor = dlib.shape_predictor("C:\\Users\\sabi\\Desktop\\Naveena_Stress\\code\\shape_predictor_68_face_landmarks.dat")
#loading the trained model
emotion_classifier = load_model("C:\\Users\\sabi\\Desktop\\Naveena_Stress\\code\\_mini_XCEPTION.102-0.66.hdf5", compile=False)
...
def normalize_values(points,disp,points_lip,dis_lip):
    ...
    if stress_value < 0.50:
        stress_label="Low Stress"
    elif stress_value > 0.50 and stress_value < 0.60:
        stress_label="Mild Stress"
    elif stress_value > 0.60:
...
class VideoCamera(object):
    ...
    #    while(True):    
        ...
        for detection in detections:
            ...
            cv2.putText(frame, emotion, (10,10),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
...
#            cv2.drawContours(frame, [openmouthhull], -1, (0, 255, 0), 1)
            ...
            cv2.putText(frame, emotion, (10,10),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
            cv2.putText(frame,"{}".format(str(int(stress_value*100))),(10,40),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
            cv2.putText(frame,"{}".format((stress_label)),(10,60),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
